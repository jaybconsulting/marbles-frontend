...
import { getHomePlayingLocation, getNextBoardPosition, isMarbleInStartHome, getPlayingHomePositionWithColourInRange, isSameBoardPosition, getHomeEndLocations, isMarbleInPlayingHome, isMarbleInEndHome, isMarbleInOneOfBoardPositions, allMarblesInEndHome, getNumAvailableSpacesInEndHome } from "../components/Board";
...
export default function calculateMoves (cardRank, currPlayer, marbles, updateMarbles) {
   ...
   else // cardRank === "J"
   {
      ...
      countPossibleMoves = calculateMovesFromMarblesInPlayForJack(marbles, boardPositionsWithAMarble, currPlayer, updateMarbles);
   }
...
function canMarbleMoveToNextBoardPosition(marble, marbles, nextBoardPosition, currPlayer, isCardMovingForward, isCardASeven, updateMarbles) {
   return !isBoardPositionOccupiedAndUnplayable (marbles, currPlayer, nextBoardPosition, true /*countTeammate*/)
       ...
       && !isMarbleInEndHomeAndNextPositionNotInEndHome(marble, nextBoardPosition) // in case a 4 is played and marble is already in end home
      ;
}
